...
ChatBot::ChatBot(const ChatBot &source) {
  std::cout << "COPYING content of chatbot instance " << &source
...
ChatBot &ChatBot::operator=(const ChatBot &source) {
  std::cout << "ASSIGNING content of chatbot instance " << &source
            << " to instance " << this << std::endl;
  if (this == &source)
    return *this;
  // delete _image;
...
ChatBot::ChatBot(ChatBot &&source) {
  std::cout << "MOVING (constructor) chatbot instance " << &source
            << " to instance " << this << std::endl;
  _image = source._image;
  _currentNode = source._currentNode;
  _rootNode = source._rootNode;
...
ChatBot &ChatBot::operator=(ChatBot &&source) {
  std::cout << "MOVING (assign) chatbot instance " << &source << " to instance "
            << this << std::endl;
  if (this == &source)
    return *this;
  delete _image;
